...
// enable this if your simulator doesn't support experiences (e.g. opensim)
//#define NOEXPERIENCES
// pick one of the following options, stick with second life if you don't know which one
#include "SLCore/LSL/SecondLifeConstants.lsl"
//#include "SLCore/LSL/OSGridConstants.lsl"
