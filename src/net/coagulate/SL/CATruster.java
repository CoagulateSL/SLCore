...
public class CATruster implements X509TrustManager, HostnameVerifier {
	...
	public CATruster() {
		try {
			...
			final X509Certificate ca=(X509Certificate) CertificateFactory.getInstance("X.509")
			                                                             .generateCertificate(stream);
			final InputStream stream2=new ByteArrayInputStream(certificate2.getBytes(StandardCharsets.UTF_8));
			final X509Certificate ca2=(X509Certificate) CertificateFactory.getInstance("X.509")
			                                                              .generateCertificate(stream2);
