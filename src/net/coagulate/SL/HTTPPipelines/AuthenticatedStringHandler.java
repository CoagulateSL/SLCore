...
public abstract class AuthenticatedStringHandler extends Handler {
	...
	private static final String loginpage1="<form method=post><p align=center>"+"<table align=center><tr><td colspan=2>"+"<h1>Welcome to Coagulate.SL</h1><br>"+"Coagulate" +
			...
			"(<a "+"href=\"https://coagulate.sl/Docs/GPHUD/\">Documentation</a>)</li>"+"<li>Quiet Life Rentals - Land rental company in Second Life (<a " +
			"href=\"https://coagulate"+".sl/Docs/QLR/\">Documentation)</a></li>"+"</ul>"+"These services are run by <a href=\"secondlife:///app/agent/8dc52677-bea8-4fc3-b69b" +
			"-21c5e2224306/about\">Iain "+"Maltz</a>"+"</p></td></tr>"+"<tr><td colspan=2>&nbsp;</td></tr>"+"<tr><td colspan=2><hr></td></tr>"+"<tr><td colspan=2>&nbsp;" +
			"</td></tr>"+"<tr><td colspan=2 "+"align=center><font size=5><u>Login</u></font></td></tr>"+"<tr><td>&nbsp;</td></tr>"+"<tr><th align=right>Avatar " +
			"Name:</th><td><input autofocus type=text "+"size=20"+" name=login_username></td></tr>";
