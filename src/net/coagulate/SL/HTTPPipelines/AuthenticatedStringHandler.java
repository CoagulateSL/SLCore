...
public abstract class AuthenticatedStringHandler extends Handler {
	...
	private static final String loginpage1="<form method=post><p align=center>"+"<table align=center><tr><td colspan=2>"+"<h1>Welcome to Coagulate SL Services</h1><br>"+"SL.Coagulate"+
			".net"+" is an umbrella service that contains a set of different services used in Second Life.<br>"+"Currently this consists of the following:<ul>"+"<li"+">RPHUD "
			...
			"(<a "+"href=\"https://sl.coagulate.net/Docs/GPHUD/\">Documentation</a>)</li>"+"<li>Quiet Life Rentals - Land rental company in Second Life (<a "+"href=\"https" +
