...
public abstract class AuthenticatedStringHandler extends StringHandler {
    ...
    private static final String loginpage="<p align=center><table><tr><td colspan=2>&nbsp;</td></tr><tr><td></td><td colspan=2 align=center><font size=5><u>Login</u></font></td></tr>"
            ...
            + "<tr><th></th><td><i><b>NOT</b> your Second Life password</i></td></tr>"
            ...
            + "<tr><td></td></tr>"
            + "<p>If you do not have a password, you must log in through Second Life<br>"
            ...
            + "<p>If you wish to avoid the Second Life step in future, and use a password, follow the above to get logged in, and then click 'Set Password' on the top right of the web pages</p>"
            + "</table></p>";
