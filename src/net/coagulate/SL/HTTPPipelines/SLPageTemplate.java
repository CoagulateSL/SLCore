...
public class SLPageTemplate extends PageTemplate {
    ...
    public SLPageTemplate(final PAGELAYOUT layout) { this.layout=layout; }
    ...
    public String getHeader() {
        ...
        r+="</td></tr></table>";
        r+="<hr></p>";
        if (layout==PAGELAYOUT.CENTERCOLUMN) { r+="<p align=center><table><tr><td style=\"max-width: 800px;\">"; }
        return r;
    }
    ...
    public String getFooter() {
        ...
        ret+=" // <a href=\"/versions\">Stack v"+ SL.getStackVersion()+" build "+SL.getStackBuildDate()+"</a>";
        ...
        if (layout==PAGELAYOUT.CENTERCOLUMN) { ret+="</td></td></table></p>"; }
        return ret;
    }
}
