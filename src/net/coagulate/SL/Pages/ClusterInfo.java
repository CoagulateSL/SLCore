...
public class ClusterInfo extends StringHandler {
    ...
    protected String handleString() {
        return "<table><tr><td style=\"max-width: 800px\";>"
                ...
                + "<p>Products remain roughly the same, self contained objects that run stand-alone, but utilise an internet host/datbase for reporting/control, and nothing more.</p>"
                ...
                + "<p>At the heart of Generation Three is MariaDB with Galera clustering, this provides an asynchronously replicating database, allowing data to be consistently written across all nodes, rather than the previous 'will apply when I can' approach of Generation Two</P>"
