...
public class Index extends Page {
    ...
    public void content() {
        ...
        raw("<tr width=100%>");
        raw("<td style=\"vertical-align: top; border-width: 1px; border-style: solid;\" width=33%>");
        raw("<h3 align=center>Tab1</h3>");
