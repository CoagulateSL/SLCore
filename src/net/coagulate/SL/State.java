...
public class State extends DumpableState {
	...
	public void setupHTTP(HttpRequest request, HttpContext context) {
		if (this.request!=null) { throw new SystemImplementationException("HTTP request is already set up"); }
		if (this.context!=null) { throw new SystemImplementationException("HTTP context is already set up"); }
		this.request=request;
		this.context=context;
		setClientIP(SL.getClientIP(request,context));
	}
	@Nonnull public HttpRequest request() { if (request==null) { throw new SystemImplementationException("No HTTP Request set up"); } return request; }
	...
	public void cookies(Map<String,String> cookieMap) {
		if (cookies!=null) { throw new SystemImplementationException("Overwriting existing cookie map"); }
		cookies=cookieMap;
	}
	public Map<String,String> cookies() {
		if (cookies==null) { throw new SystemImplementationException("Cookies map not initialised"); }
		return cookies;
	}
	private final Map<String,String> parameters=new TreeMap<>();
	public void parameters(Map<String,String> parametersMap) {
	...
	private void setClientIP(String s) { this.clientIp =s; }
	public String getClientIP() {
		return clientIp;
	}

	private JSONObject in=null;
	public void jsonIn(JSONObject json) {
		if (in!=null) { throw new SystemImplementationException("JSON IN already set"); }
		in=json;
	}
	public JSONObject jsonIn() {
		if (in==null) { throw new SystemImplementationException("JSON IN is null"); }
		return in;
	}
	...
	public void page(Page page) { if (this.page!=null) { throw new SystemImplementationException("Page already set"); } this.page=page; }
	@Nonnull public Page page() { if (page==null) { throw new SystemImplementationException("Page is not set"); } return page; }
	@Nonnull public Container root() { return page().root(); }
	public State add(Container container) { page().add(container); return this; }
	...
	public void entity(HttpEntity setTo) {
		if (entity!=null) { throw new SystemImplementationException("Http Entity is already set!"); }
		entity=setTo;
	}
	public HttpEntity entity() {
		if (entity==null) { throw new SystemImplementationException("Http Entity is null"); }
		return entity;
	}
